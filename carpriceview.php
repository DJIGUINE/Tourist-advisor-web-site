...
$query_Recordset2 = sprintf("SELECT * FROM car WHERE car_id = %s", GetSQLValueString($colname_Recordset2, "int"));
...
<ul id="MenuBar1" class="MenuBarHorizontal">
  ...
  <li><a href="customerhotelbooking.php">Booking </a></li>
    ...
    <div align="center">
      <table width="239" border="1">
        ...
        <tr>
          ...
          <td><div align="center"><?php echo $row_Recordset2['carprice']; ?></div></td>
          <td><?php echo $row_Recordset2['cartype']; ?></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <form id="form1" name="form1" method="POST" action="payementcar.php">
        <div align="center">
        <table width="291" border="0">
          <tr>
            <td width="173" height="31"><p>Car Price</p></td>
            <td width="102"><label for="price"></label>
              <input type="text" name="price" id="price" min="100"  max="900"placeholder="0$" required="required" /></td>
          </tr>
          <tr>
            <td height="30"><p>Number of Day</p></td>
