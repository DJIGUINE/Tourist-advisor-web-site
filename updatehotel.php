...
<body><?php require_once('Connections/tourisme.php'); ?>
<?php
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE hotel SET hotelname=%s, hoteltype=%s WHERE hotel_id=%s",
                       GetSQLValueString($_POST['hotelname'], "text"),
                       GetSQLValueString($_POST['hoteltype'], "text"),
...
if (isset($_GET['hotel_id'])) {
  $colname_Recordset1 = $_GET['hotel_id'];
}
mysql_select_db($database_tourisme, $tourisme);
$query_Recordset1 = sprintf("SELECT * FROM hotel WHERE hotel_id = %s", GetSQLValueString($colname_Recordset1, "int"));
$Recordset1 = mysql_query($query_Recordset1, $tourisme) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
<div align="center" id="body">
  <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
    <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Hotel_id:</td>
      <td><?php echo $row_Recordset1['hotel_id']; ?></td>
    </tr>
    <tr valign="baseline">
      <td height="34" align="right" nowrap="nowrap">Hotelname:</td>
      <td><input type="text" name="hotelname" value="<?php echo htmlentities($row_Recordset1['hotelname'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td height="33" align="right" nowrap="nowrap">Hoteltype:</td>
      <td><input type="text" name="hoteltype" value="<?php echo htmlentities($row_Recordset1['hoteltype'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="hotel_id" value="<?php echo $row_Recordset1['hotel_id']; ?>" />
</form>
<p>&nbsp;</p>
<p>&nbsp;</p>
</div>
