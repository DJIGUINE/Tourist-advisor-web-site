...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE product SET productprice=%s, productype=%s WHERE product_id=%s",
                       GetSQLValueString($_POST['productprice'], "int"),
                       GetSQLValueString($_POST['productype'], "text"),
  ...
  $updateGoTo = "adminaddshoplinfo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_tourisme, $tourisme);
$query_Recordset1 = sprintf("SELECT * FROM product WHERE product_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<ul id="MenuBar1" class="MenuBarHorizontal">
  ...
  <li><a href="adminaddshoplinfo.php"> ADD  Shop</a></li>
  <li><a href="editpurshase.php">Edit  Booking</a>  </li>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  <table align="center">
    <tr valign="baseline">
      <td height="28" align="right" nowrap="nowrap">Product_id:</td>
      <td><?php echo $row_Recordset1['product_id']; ?></td>
    </tr>
    <tr valign="baseline">
      <td height="37" align="right" nowrap="nowrap">Productprice:</td>
      <td><input type="text" name="productprice" value="<?php echo htmlentities($row_Recordset1['productprice'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td height="34" align="right" nowrap="nowrap">Productype:</td>
      <td><input type="text" name="productype" value="<?php echo htmlentities($row_Recordset1['productype'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
