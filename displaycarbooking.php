...
$colname_Recordcar = "-1";
if (isset($_POST['name'])) {
  $colname_Recordcar = $_POST['name'];
}
mysql_select_db($database_tourisme, $tourisme);
$query_Recordcar = sprintf("SELECT * FROM carbooking WHERE customernamefk = %s", GetSQLValueString($colname_Recordcar, "text"));
$Recordcar = mysql_query($query_Recordcar, $tourisme) or die(mysql_error());
$row_Recordcar = mysql_fetch_assoc($Recordcar);
$totalRows_Recordcar = mysql_num_rows($Recordcar);
...
<title>display car booking</title>
...
<p align="center">
  <?php if ($totalRows_Recordcar > 0) { // Show if recordset not empty ?>
<div align="center">
  <h1>Search Booking</h1>
  <h1>Please write your full name </h1>
</div>
<form id="form1" name="form1" method="post" action="displaycarbooking.php">
  <div align="center">
...
<div align="center">
  <table width="797" border="1">
    <tr>
      <td width="73" height="30">ID BOOKING</td>
      <td width="73">Car id</td>
      <td width="73">Name</td>
    ...
    <tr>
      <td><?php echo $row_Recordcar['bookingcar_id']; ?></td>
      <td><?php echo $row_Recordcar['car_idfk']; ?></td>
      <td><?php echo $row_Recordcar['customernamefk']; ?></td>
      <td><?php echo $row_Recordcar['bookFROM']; ?></td>
      <td><?php echo $row_Recordcar['to_']; ?></td>
      <td><?php echo $row_Recordcar['number_Day']; ?></td>
      <td><?php echo $row_Recordcar['adressemail']; ?></td>
      <td width="67"><a href="custupdatecar.php?bookingcar_id=<?php echo $row_Recordcar['bookingcar_id']; ?>">Update</a></a></a></td>
      <td width="64"><a href="deletecar.php?bookingcar_id=<?php echo $row_Recordcar['bookingcar_id']; ?>">Delete</a></td>
      </tr>
    </table>
  <p>&nbsp;</p>
</div>
...
<?php if ($totalRows_Recordcar == 0) { // Show if recordset empty ?>
