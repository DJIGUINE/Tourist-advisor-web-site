...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO carbooking (car_idfk, customernamefk, bookFROM, to_, number_Day, adressemail) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "carcomfirmbooking.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
  <div align="center">
    <table width="291" border="0">
      <tr>
        <td width="173" height="35"><p>CAR  ID</p></td>
        <td width="102"><label for="carid"></label>
          <input type="text" name="carid" id="carmid" min="1" placeholder= "0"required="required" /></td>
      </tr>
      <tr>
        <td height="30"><p>Customer Name</p></td>
      ...
      <tr>
        <td height="30"><p>Email Adress</p></td>
