...
<div align="center">
  ...
  <?php if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>
    <table width="873" border="1">
      <tr>
        <td width="73">Password</td>
        <td width="73">Email adress</td>
        <td width="73">Name</td>
        <td width="76">Telephone</td>
        <td colspan="2">&nbsp;</td>
      </tr>
      <tr>
        ...
        <td width="67"><a href="updatecostumer.php?customer_id=<?php echo $row_Recordset1['customer_id']; ?>">Update</a></td>
        <td width="64"><a href="deletecustomer.php?customer_id=<?php echo $row_Recordset1['customer_id']; ?>">Delete</a></td>
      </tr>
    </table>
    <h1>&nbsp;</h1>
...
<h1 align="center"><span class="clor">
  <?php if ($totalRows_Recordset1 == 0) { // Show if recordset empty ?>
sorry recorde not found try again
