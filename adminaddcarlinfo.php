...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO car (carprice, cartype) VALUES (%s, %s)",
                       GetSQLValueString($_POST['txtcarprice'], "int"),
                       GetSQLValueString($_POST['txtcartype'], "text"));

  mysql_select_db($database_tourisme, $tourisme);
  $Result1 = mysql_query($insertSQL, $tourisme) or die(mysql_error());

  $insertGoTo = "adminaddcarlinfo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <div align="center">
    ...
    <table width="250" border="0">
      <tr>
        ...
        <td><label for="txtcarprice"></label>
        <input type="text" name="txtcarprice" id="txtcarprice" min="1"  placeholder="$" required="required"/></td>
      </tr>
      <tr>
        <td height="36">Type</td>
        <td><label for="txtcartype"></label>
        <input type="text" name="txtcartype" id="txtcartype"  placeholder="type" required="required" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><div align="center">
...
<div align="center">
  ...
  <table width="669" border="1">
    <tr>
      <td width="59">ID</td>
      <td width="93">Car price</td>
      <td width="161">Car type</td>
      <td colspan="2">&nbsp;</td>
    </tr>
    <?php do { ?>
      <tr>
        <td><?php echo $row_Recordset1['car_id']; ?></td>
        <td><?php echo $row_Recordset1['carprice']; ?></td>
        <td><?php echo $row_Recordset1['cartype']; ?></td>
        <td width="161"><a href="updatecar.php?car_id=<?php echo $row_Recordset1['car_id']; ?>">Update</a></td>
        <td width="161"><a href="deletecarinfo.php?car_id=<?php echo $row_Recordset1['car_id']; ?>">Delete</a></td>
      </tr>
