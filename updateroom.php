...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE room SET hotel_id=%s, roomprice=%s, roomtype=%s WHERE room_id=%s",
                       GetSQLValueString($_POST['hotel_id'], "int"),
                       GetSQLValueString($_POST['roomprice'], "int"),
  ...
  $updateGoTo = "adminaddhotelinfo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['room_id'])) {
  $colname_Recordset1 = $_GET['room_id'];
}
mysql_select_db($database_tourisme, $tourisme);
$query_Recordset1 = sprintf("SELECT * FROM room WHERE room_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<ul id="MenuBar1" class="MenuBarHorizontal">
  ...
  <li><a href="adminaddhotelinfo.php"> ADD  Hotel </a></li>
...
<div align="center" id="body">
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table align="center">
    <tr valign="baseline">
      <td height="31" align="right" nowrap="nowrap">Room_id:</td>
      <td><?php echo $row_Recordset1['room_id']; ?></td>
    </tr>
    <tr valign="baseline">
      <td height="34" align="right" nowrap="nowrap">Hotel_id:</td>
      <td><input type="text" name="hotel_id" value="<?php echo htmlentities($row_Recordset1['hotel_id'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td height="31" align="right" nowrap="nowrap">Roomprice:</td>
      <td><input type="text" name="roomprice" value="<?php echo htmlentities($row_Recordset1['roomprice'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td height="29" align="right" nowrap="nowrap">Roomtype:</td>
      <td><input type="text" name="roomtype" value="<?php echo htmlentities($row_Recordset1['roomtype'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="room_id" value="<?php echo $row_Recordset1['room_id']; ?>" />
</form>
<p>&nbsp;</p>
</div>
<p>&nbsp;</p>
