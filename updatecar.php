...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE car SET carprice=%s, cartype=%s WHERE car_id=%s",
                       GetSQLValueString($_POST['carprice'], "int"),
                       GetSQLValueString($_POST['cartype'], "text"),
  ...
  $updateGoTo = "adminaddcarlinfo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['car_id'])) {
  $colname_Recordset1 = $_GET['car_id'];
}
mysql_select_db($database_tourisme, $tourisme);
$query_Recordset1 = sprintf("SELECT * FROM car WHERE car_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  <table align="center">
    ...
    <tr valign="baseline">
      <td height="28" align="right" nowrap="nowrap">Carprice:</td>
      <td><input type="text" name="carprice" value="<?php echo htmlentities($row_Recordset1['carprice'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td height="36" align="right" nowrap="nowrap">Cartype:</td>
      <td><input type="text" name="cartype" value="<?php echo htmlentities($row_Recordset1['cartype'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="car_id" value="<?php echo $row_Recordset1['car_id']; ?>" />
</form>
<p>&nbsp;</p>
<div align="center">
  <h2>&nbsp;</h2>
