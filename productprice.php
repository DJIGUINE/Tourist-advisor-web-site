...
$query_Recordset2 = sprintf("SELECT * FROM product WHERE product_id = %s", GetSQLValueString($colname_Recordset2, "int"));
...
<ul id="MenuBar1" class="MenuBarHorizontal">
  ...
  <li><a href="customerpurshace.php">Booking </a></li>
    ...
    <div align="center">
      <table width="239" border="1">
        ...
        <tr>
          ...
          <td><div align="center"><?php echo $row_Recordset2['productprice']; ?></div></td>
          <td><?php echo $row_Recordset2['productype']; ?></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
